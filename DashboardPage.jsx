      ...
      <div className="landing-hero" style={{ position: "relative", zIndex: 5 }}>
        ...
        <div style={{ animation: "fadeUp .8s ease both .1s", opacity: 0, width: "100%", maxWidth: 800 }}>
          ...
          <p style={{ fontFamily: "var(--font-body)", color: "var(--text-dim)", lineHeight: 1.75, fontSize: "clamp(14px,1.8vw,18px)", maxWidth: 520, margin: "0 auto 38px" }}>
            Use soil data, weather patterns, and artificial intelligence to deeply understand the food security potential of your farmland.
          </p>
        ...
        {/* Stats */}
        <div className="hero-stats" style={{ display: "flex", gap: "clamp(28px,5vw,64px)", marginTop: "clamp(44px,6vw,80px)", animation: "fadeUp .8s ease both .4s", opacity: 0, justifyContent: "center", flexWrap: "wrap" }}>
