...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      case "landing":   return <LandingPage onNav={setPage} />;
      case "login":     return <AuthPage mode="login" onNav={setPage} />;
      case "register":  return <AuthPage mode="register" onNav={setPage} />;
      case "dashboard": return <DashboardPage onNav={setPage} />;
      case "analyze":   return <AnalyzePage onNav={setPage} />;
      case "history":   return <HistoryPage onNav={setPage} />;
      default:          return <LandingPage onNav={setPage} />;
    }
  };
